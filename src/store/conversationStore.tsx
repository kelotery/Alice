...
export type PageMode = "home" | "chat" | "autoTasks";
export type AppPage = "home" | "chat" | "autoTasks" | "taskDetail";
...
type Action =
  | { type: "GO_HOME" } | { type: "GO_AUTO_TASKS" }
...
interface CtxVal { state: State; goHome: ()=>void; goAutoTasks: ()=>void; createConversation: (fm:string)=>void; selectConversation: (id:string)=>void; sendMessage: (ct:string)=>void; pinConversation: (id:string)=>void; renameConversation: (id:string,t:string)=>void; deleteConversation: (id:string)=>void; toggleRightPanel: ()=>void; setWorkPanelTab: (t:WorkPanelTab)=>void; currentConversation: Conversation|null; }
...
export function ConversationProvider({ children }: { children: ReactNode }) {
  ...
  return <Ctx.Provider value={{state,goHome,goAutoTasks,createConversation,selectConversation,sendMessage,pinConversation,renameConversation,deleteConversation,toggleRightPanel,setWorkPanelTab,currentConversation}}>{children}</Ctx.Provider>;
}
